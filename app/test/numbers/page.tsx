...
export default function TestNumbersPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-300 to-red-400 p-8 relative">
      {/* Celebration Overlay */}
      {showCelebration && (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-2xl p-6 mb-8">
          <div className="flex justify-between items-center">
            <div className="text-center flex-1">
              ...
              <p className="text-8xl font-bold text-purple-600">{currentNumber}</p>
            </div>
            <div className="text-center flex-1">
        ...
        <div className="bg-white rounded-xl shadow-2xl p-8">
          ...
          <div className="text-center mb-6">
            <h2 className="text-3xl font-bold text-gray-800 mb-2">
              Write the number: <span className="text-purple-600">{currentNumber}</span>
            </h2>
            {modelError ? (
          ...
          <div className="text-center">
            <button
              ...
              className="px-12 py-4 bg-purple-500 text-white rounded-lg font-bold text-2xl hover:bg-purple-600 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors shadow-lg"
            >
        ...
        <div className="mt-8 bg-white/80 rounded-xl p-6">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 text-lg">
            <li>Write each number carefully</li>
            <li>Only ONE attempt per number</li>
            <li>Click Submit to move to the next number</li>
            <li>Your score will be shown at the end</li>
            <li>Incorrect numbers will be retested in a corrected test</li>
          </ul>
        </div>
      </div>
